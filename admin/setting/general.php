<div class="row g-5 small">
    <div class="col-md-7 col-lg-8">
        <h5 class="mb-3">Cài đặt chung</h5>
        <form class="needs-validation" novalidate="">
            <div class="row g-3">
                <div class="col-sm-6">
                    <label for="firstName" class="form-label">Giao diện</label>
                ...
                <div class="col-sm-6">
                    <label for="firstName" class="form-label">Ngôn ngữ</label>
                    <select class="form-control form-control-sm" id="country" required="">
            ...
            <button class="w-100 btn btn-primary btn-sm" type="submit">Lưu</button>
        </form>
    </div>
</div>