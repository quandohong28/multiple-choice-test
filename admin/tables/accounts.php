                                ...
                                <div class="col-12 col-lg-9 col-xl-7">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-4 d-flex align-items-center">
                                            <div class="form-outline w-100">
                                                <label for="fullname" class="form-label">Họ và tên</label>
                                                <input type="text" name="edit_fullname"
                                        ...
                                        <div class="col-md-6 mb-4 d-flex align-items-center">
                                            <div class="form-outline w-100">
                                                <label class="form-label" for="emailAddress">Email</label>
                                                <input type="email" id="edit_emailAddress" name="edit_emailAddress"
                                    ...
                                    <div class="row">
                                        <div class="col-12 mb-4 d-flex align-items-center">
                                            <div class="form-outline datepicker w-100">
                                                <label for="introduce" class="form-label">Mô tả</label>
                                                <textarea name="edit_introduce" cols="30" rows="3" value=""
                                                    placeholder="" class="form-control form-control-sm"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-4 pb-2">
                                            <div class="form-outline">
                                                <label class="form-label" for="avatar">Ảnh đại diện</label>
                                                <input class="form-control form-control-sm" id="avatar"
                                                    name="edit_avatar" value="" type="hidden" />
                                                <input class="form-control form-control-sm" id="avatar"
                                                    name="edit_avatar" type="file" />
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" value="" placeholder="" name="edit_id" id="id">
