...
<a class="btn btn-info mb-2" href="?act=tables&data=add_account" data-toggle="modal" data-target="#addaccountmodal">Thêm
    tài khoản</a>
    ...
    <tbody>
        <tr class="">
            ...
            <td class="d-flex gap-3">
                <a class="btn btn-warning btn-sm" href="?act=tables&data=edit_account" data-toggle="modal"
                    data-target="#editaccountmodal"><i class="fa-regular fa-pen-to-square"></i></a>
