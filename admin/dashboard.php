                        ...
                        <div class="col mr-2">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="input-group">
                                    <select name="interval" id="" class="form-control form-control-sm">
                                ...
                                <div class="custom-date d-none justify-content-between mt-3">
                                    <div class="">
                                        <small>Từ ngày</small>
                ...
                <div class="card-body">
                    <form action="?act=statistic_result_detail" method="post">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" name="exam_code" id="exam_code" class="form-control form-control-sm" placeholder="VD: PFNDIEK" aria-describedby="helpId">
