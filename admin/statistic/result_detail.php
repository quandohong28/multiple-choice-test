        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Số lượng câu hỏi
                            </div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= $result_detail[0]['number_question'] ?>
                            </div>
                        </div>
                        <div class="col-auto">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Thời gian làm bài
                                trung bình</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= number_format($avg_exam_time['average_exam_time_minutes'], 2) . ' phút' ?>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                <?= number_format($avg_point['average_points'], 2) ?>
                            </div>
                        </div>
                        <div class="col-auto">
