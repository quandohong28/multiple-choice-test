    ...
    <div class="bg-primary-gradient py-5">
        <div class="row">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                <p class="fw-bold">
                    <span>Xin chào</span>
                    <a href="?act=profile" class="text-success mb-2 text-decoration-none">Đỗ Hồng Quân</a>
                </p>
                ...
                <div class="col mb-5">
                    <div class="card shadow-sm">
                        <div class="card-body shadow rounded px-4 py-5 px-md-5">
                            ...
                            <p class="text-muted card-text mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis sit perferendis, laborum earum error quibusdam recusandae laboriosam amet, eum temporibus eius voluptate adipisci corrupti? Nam inventore repellat facilis architecto laudantium!</p>
                ...
                <div class="col mb-4">
                    <div class="card shadow-sm">
                        <div class="card-body shadow rounded px-4 py-5 px-md-5">
                            ...
                            <p class="text-muted card-text mb-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis neque ex doloremque obcaecati ut eius consectetur eos. Deserunt, rerum amet blanditiis, adipisci, velit corrupti accusantium quidem ducimus impedit quo voluptate?</p>
                ...
                <div class="col mb-4">
                    <div class="card bg-primary-subtle">
                        <div class="card-body text-center px-4 py-5 px-md-5">
                            ...
                            <h5 class="fw-bold card-title mb-3">Toán rời rạc</h5>
                            <button class="btn btn-sm btn-outline-primary" type="button">Learn more</button>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="card bg-secondary-subtle">
                        <div class="card-body text-center px-4 py-5 px-md-5">
                            ...
                            <h5 class="fw-bold card-title mb-3">Cấu trúc dữ liệu và giải thuật</h5>
                            <button class="btn btn-outline-danger btn-sm" type="button">Learn more</button>
                        </div>
                    </div>
                </div>
                <div class="col mb-4">
                    <div class="card bg-info-subtle">
                        <div class="card-body text-center px-4 py-5 px-md-5">
                            ...
                            <h5 class="fw-bold card-title mb-3">Lập trình C cơ bản</h5>
                            <button class="btn btn-outline-success btn-sm" type="button">Learn more</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 col-xl-4">
                <div>
                    <form class="p-3 p-xl-4" method="post" data-bs-theme="light"><!-- Start: Success Example -->
                        <div class="mb-3"><input class="form-control" type="text" id="name-1" name="name" placeholder="Họ và tên">
                        ...
                        <div class="mb-3"><textarea class="form-control" id="message-1" name="message" rows="6" placeholder="Miêu tả cho chúng tôi vấn đề của bạn"></textarea></div>
