                            ...
                            <div class="collapse ps-5 show" id="home-collapse">
                                ...
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                    <?php foreach ($categories as $category):
                                        extract($category);
                                        ?>
                                        <li><a href="#" data-bs-toggle="modal" data-bs-target="#practiceConfigModal"
                                                class="link-dark">•
                                                <?= $name ?>
                                            </a></li>
                                    <?php endforeach ?>
                                        ...
                                        <div class="d-flex align-items-start justify-content-between">
                                            <div class="p-5">
                                                ...
                                                <button type="button" class="btn btn-outline-primary btn-sm"
                                                    data-bs-toggle="modal" data-bs-target="#practiceConfigModal"
                                                    data-bs-value='<?= json_encode($category) ?>'>
                                                    Thử ngay
                                                </button>

                                            </div>
                                            <img class="img-fluid image col-7" src="<?= $category_image . $image ?>"
                                                alt="..." />
                                        </div>
                                    </div>
                                </div>
