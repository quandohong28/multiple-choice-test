    ...
    <script>
        ...
        // Xử lý status khi người dùng bấm nộp bài
        status_exam.innerHTML = 'Bạn đã chọn ' + number_selected_answer + '/' + questions.length + ' câu trả lời';
    </script>