        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <div class="dropdown text-end">
                <a href="" class="d-block link-body-emphasis text-decoration-none dropdown-toggle"
                    ...
                    <img src="<?= '../assets/img/accounts/' . getAccountById($_SESSION['user']['id'])['avatar'] ?>"
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a class="dropdown-item text-danger" href="#" data-bs-toggle="modal"
                            data-bs-target="#logoutModal"><i class="fa-solid fa-arrow-right-from-bracket me-3"></i>Đăng
                            xuất</a>
                    </li>
                </ul>
            </div>

            <button class="btn btn-link dropdown-toggle" aria-expanded="false" data-bs-toggle="dropdown" type="button"
                style="color: var(--bs-body-color);"><svg class="bi bi-sun-fill mb-1" xmlns="http://www.w3.org/2000/svg"
