				...
				<div class="card">
					<div class="card-body text-center d-flex flex-column align-items-center">
						...
						<form method="post" data-bs-theme="light">
							...
							<div class="mb-3"><input class="form-control" type="password" name="conf_pass" placeholder="Nhập lại mật khẩu">
							</div>
							<div class="mb-3"><button class="btn btn-sm btn-primary shadow d-block w-100" type="submit">Đăng ký</button>
							</div>
						</form>
