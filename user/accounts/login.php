		...
		<div class="col-md-6 col-xl-4">
			<div class="card">
				<div class="card-body text-center d-flex flex-column align-items-center">
					...
					<p class="text-muted">Bạn chưa có tài khoản? <a href="?act=signup">Đăng ký</a></p>
					<p class="text-muted">Bạn quên mật khẩu? <a href="?act=forgot_password">Quên mật khẩu</a></p>
				</div>
			</div>
		</div>
	</div>
